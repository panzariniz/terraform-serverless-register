...
resource "aws_ssm_parameter" "message_bird_sms_phone_from" {
  name  = "${var.environment}-message-bird-sms-phone-from"
  type  = "String"
  value = "${var.message_bird_sms_phone_from}"
}

resource "aws_ssm_parameter" "message_bird_sms_phone_to" {
  name  = "${var.environment}-message-bird-sms-phone-to"
  type  = "String"
  value = "${var.message_bird_sms_phone_to}"
}
